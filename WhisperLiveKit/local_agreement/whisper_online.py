...
def backend_factory(
    ...
    # Set beam_size if provided (BEFORE warmup so warmup uses correct beam_size)
    if beam_size is not None:
        asr.transcribe_kargs['beam_size'] = beam_size
    ...
    asr.keywords_file = keywords_file
    
    keywords_manager = KeywordsManager(keywords_file)
    asr.keywords = keywords_manager.get_keywords()
    asr.keywords_string = keywords_manager.get_keywords_as_string()
